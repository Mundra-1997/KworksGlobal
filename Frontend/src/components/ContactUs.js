  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Talk to us to see what running a business is like with FinTeam on your side. Drop us email at : info@finTeam.one"
        />
      ...
      <div className="wrapper">
        <div className="div1">
          ...
          <p className="hero-para">
            Talk to us to see what running a business is like with FinTeam on
            your side.
          </p>
          <p className="drop">
            Drop us email at :<b> info@finTeam.one</b>
          </p>
        </div>
        <div className="div2">
