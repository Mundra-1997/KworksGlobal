...
const NewServices = () => {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="Services Page" content="Partner with our on-demand services. From bookkeeping to strategic planning, M&A, fund & investment accounting and more, our certified team manages it all." />  
    </Helmet>
    <div className="boxesss">
      <ReactCardFlip isFlipped={flip} flipDirection="vertical">
        ...
        <div className="back-side" onClick={() => setFlip(!flip)}>
          <p>
            ...
            <br /> Breathe easy with organized finances! We tame tangled records
            & conquer month-end close with flawless accuracy. Stay informed,
            stay ahead.
          </p>
        </div>
      </ReactCardFlip>
      ...
      <ReactCardFlip isFlipped={flip2} flipDirection="vertical">
        ...
        <div className="back-side" onClick={() => setFlip2(!flip2)}>
          <p>
            ...
            <br /> Stop guessing, start knowing. We analyze your numbers, reveal
            insights, and guide you to goals. Expert analysis, actionable steps
            - your financial compass to navigate with confidence.
          </p>
        </div>
      </ReactCardFlip>
      <ReactCardFlip isFlipped={flip3} flipDirection="vertical">
        ...
        <div className="back-side" onClick={() => setFlip3(!flip3)}>
          <p>
            ...
            experts navigate the chaos, keeping you squeaky clean with the IRS.
            Relax, your finances are in good hands.
          </p>
        </div>
      </ReactCardFlip>
      <ReactCardFlip isFlipped={flip4} flipDirection="vertical">
        ...
        <div className="back-side" onClick={() => setFlip4(!flip4)}>
          <p>
            ...
            <br /> Uncover hidden value & close deals faster with our accounting
            navigators. Expert due diligence, financial forecasting, tax
            optimization—chart your course to merger & acquisition success.
          </p>
        </div>
      </ReactCardFlip>
      <ReactCardFlip isFlipped={flip5} flipDirection="vertical">
        ...
        <div className="back-side" onClick={() => setFlip5(!flip5)}>
          <p>
            Dust off spreadsheets, unleash growth. AI scans your finances, finds
            hidden inefficiencies. Automate tasks, gain crystal insights, watch
            profits bloom. We partner with top tech, cutting endless demos.
            Tailor your system, dominate your industry. Lead the finance
            revolution supporting Future of Finance
          </p>
        </div>
      </ReactCardFlip>
      <ReactCardFlip isFlipped={flip6} flipDirection="vertical">
        ...
        <div className="back-side" onClick={() => setFlip6(!flip6)}>
          <p>
            ...
            smarter, not harder on paydays. Relax, hand off payroll to the pros,
      ...
      <ReactCardFlip isFlipped={flip7} flipDirection="vertical">
        ...
        <div className="back-side" onClick={() => setFlip7(!flip7)}>
          <p>
            Invest boldly, not blindly. Our accounting & equity experts empower
            you with clarity, insights, and guidance to unlock maximum returns
            and conquer your financial goals. From bookkeeping brilliance to
            expert market navigation, we're your trusted co-pilot on the journey
